...
def heal(max_HP):
    ...
    if heals != []:
        ...
        for heal in heals:
            print(heal + ",")
        hc = input("\nWhich heal do you want to use? ")
        print("\n")
        if hc == "Small HP Potion":
...
while True:
    if r_count == 1:
        ...
        if r4 == False:
            ...
            print("You've alredy been in this room.")
        while True:
            go4 = input("\nThere is a hallway going forward and then turning right, it is aglow with embers. Do you follow it or go back?(follow it or go back) ")
            if go4 == "follow it":
                r_count +=5
                break
            elif go4 == "go back":
        ...
        if r5 == False:
            ...
            print("You've alredy been in this room.")
        while True:
            go5 = input("\nStraight in front of you a hallway expels sulfur and heat. Do you follow it or go back?(follow it or go back) ")
            if go5 == "follow it":
                r_count +=4
                break
            elif go5 == "go back":
